					...
					<div class="row mb-2">
						<div class="col-sm-6">
							...
							<i class="fa-solid  fa-circle-user"></i>
								Data Referensi Kata</h3>
						</div>
						<div class="col-sm-6">
							<a role="button" class="btn btn-primary mt-2 float-lg-right"
								href="<?php echo site_url('referensi/simpan')?>"><i class="fa-solid fa-plus"></i> Tambah
								Data</a>
						</div>
			...
			<div class="container-2xl mx-3 py-3">
				<center>
					<table id="myTable" class="table table-hover text-center" style="width:100%">
						...
						<tbody>
							<?php foreach ($referensi as $l):  ?>
							<tr>
								<td class=""><?php echo $l['id'] ?></td>
								<td class=""><?php echo $l['kata_id'] ?></td>
								<td class=""><?php echo $l['nama_ref'] ?></td>
								<td class=""><?php echo $l['deskripsi'] ?></td>
								<td class="">
									<a href="<?php echo site_url('referensi/ubah/' . $l['id']) ?>"
										class="btn btn-success"><i class="fa-solid fa-pen-to-square"></i></a>
									<a href="<?php echo site_url('referensi/hapus/' . $l['id']) ?>"
