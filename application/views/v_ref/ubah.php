        ...
        <form action="" method="post">
              ...
              <div class="card-body">
                  <div class="mb-3">
                      ...
                      <input type="text" name="id" class="form-control" value="<?php echo $referensi->id ?>" hidden>
                      <!-- <input type="text" name="id_parent" class="form-control" value="<?php echo $kata->id_parent ?>"> -->
                  </div>
                  <div class="mb-3">
                      <label for="" class="form-label">Nama Referensi</label>
                      <input type="text" name="nama_ref" class="form-control" value="<?php echo $referensi->nama_ref ?>">
                  </div>
                  <div class="mb-3">
                      <label for="" class="form-label">Deskripsi</label>
                      <input type="text" name="deskripsi" class="form-control" value="<?php echo $referensi->deskripsi ?>">
                  </div>
                  <div class="mb-3">
